...
export default {
  ...
  logo: Logo,
  short_description:
    "Connect Perplexity to your DX data with AI-powered search.",
  description: `Connect Perplexity to your DX account using the Model Context Protocol (MCP).
...
3. Add your DX API key and start asking questions`,
  images: [],
