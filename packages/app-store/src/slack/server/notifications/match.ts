import { getAppByAppId } from "@dx/db/queries";
import { getWorkerDb } from "@dx/db/worker-client";
import { createLoggerWithContext } from "@dx/logger";
            ...
            elements: [
              {
                ...
                url: `https://app.dx.tips/transactions?id=${encodeURIComponent(transactionId)}`,
          ...
          },
          {
            ...
            elements: [
              ...
              },
              {
                ...
                url: `https://app.dx.tips/inbox?inboxId=${encodeURIComponent(inboxId)}`,
