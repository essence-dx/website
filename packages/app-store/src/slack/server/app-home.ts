import type { Database } from "@dx/db/client";
import { getTeamById } from "@dx/db/queries";
    ...
    const blocks = [
      ...
      // Status Section
      {
        ...
        accessory: {
          ...
          url: "https://app.dx.tips/apps?app=slack&settings=true",
      ...
      // Footer
      {
        ...
        elements: [
          {
            type: "mrkdwn" as const,
            text: "Upload receipts by sharing files in channels where DX is added. Data will be automatically extracted and matched to your transactions.",
          },
        ],
      },
    ];
