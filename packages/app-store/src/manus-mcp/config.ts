...
export default {
  ...
  active: true,
  logo: Logo,
  short_description: "Connect Manus to your DX financial data via MCP.",
  description: `Connect Manus to your DX account using the Model Context Protocol (MCP).
...
2. Enter the server URL: \`https://api.dx.tips/mcp\`
3. Authenticate with your DX account when prompted

**Requirements:** Manus account with MCP connector support.`,
  images: [],
  installUrl: "https://dx.tips/mcp/manus",
};
