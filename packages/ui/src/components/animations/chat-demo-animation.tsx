...
const NOTIFICATION_MP3 = "https://cdn.dx.tips/notification.mp3";
const KEYBOARD_MP3 = "https://cdn.dx.tips/keyboard.mp3";
    ...
    steps: [
      {
        ...
        attachment: {
          ...
          amount: "SEK 1,018.35",
          imageSrc: "https://cdn.dx.tips/chat-receipt-hemkop.png",
        },
        delayAfterMs: 700,
      },
      {
  ...
  for (let si = 0; si < scenarioCount; si++) {
    ...
    if (config.startOnLockScreen) {
      ...
      for (let stepIdx = 1; stepIdx < config.steps.length; stepIdx++) {
        ...
        if (step.sender === "DX" && step.typingMs) {
        ...
        snap(step.sender === "user" ? HOLD_USER_MESSAGE : HOLD_DX_MESSAGE);
      ...
      if (firstStep) {
        ...
        if (firstStep.sender === "DX" && firstStep.typingMs) {
          snap(HOLD_TYPING, { isTyping: true });
        }
...
function IOSKeyboard() {
  return (
    <img
      src="https://cdn.dx.tips/ios-keyboard-dark-v1.svg"
      alt=""
      draggable={false}
...
/* ------------------------------------------------------------------ */
/*  DX logo (inlined SVG, white on black)                          */
/* ------------------------------------------------------------------ */
...
const LOCK_SCREEN_WALLPAPER = "https://cdn.dx.tips/background-remote-v7.png";
...
const RECEIPT_IMAGE_SRC = "https://cdn.dx.tips/reciept.jpg";
    ...
    >
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <a
            href="https://cal.com/pontus-DX/15min"
            target="_blank"
