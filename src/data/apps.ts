import { apps as appStoreApps } from "@dx/app-store";
import {
...
> = {
  ...
  "dx-desktop": {
    ...
    installUrl: "https://dx.tips/download",
  },
  "google-drive": {
    slug: "google-drive",
    features: [
  ...
  "cursor-mcp": {
    ...
    installUrl: "https://dx.tips/mcp/cursor",
  },
  "claude-mcp": {
    slug: "claude-mcp",
    features: [
  ...
  "perplexity-mcp": {
    ...
    installUrl: "https://dx.tips/mcp/perplexity",
  },
  "raycast-mcp": {
    slug: "raycast-mcp",
    features: [
    ...
    installUrl: "https://dx.tips/mcp/raycast",
  },
  "chatgpt-mcp": {
    slug: "chatgpt-mcp",
    features: [
    ...
    installUrl: "https://dx.tips/mcp/chatgpt",
  },
  "opencode-mcp": {
    slug: "opencode-mcp",
    features: [
    ...
    installUrl: "https://dx.tips/mcp/opencode",
  },
  "zapier-mcp": {
    slug: "zapier-mcp",
    features: [
  ...
  "copilot-mcp": {
    ...
    installUrl: "https://dx.tips/mcp/copilot",
  },
  "n8n-mcp": {
    slug: "n8n-mcp",
    features: [
      "Build automated financial workflows",
      "AI agents with DX tools",
      "Connect to 400+ apps via n8n",
      "MCP Client & Server support",
    ],
    installUrl: "https://dx.tips/mcp/n8n",
  },
  "make-mcp": {
    slug: "make-mcp",
    features: [
    ...
    installUrl: "https://dx.tips/mcp/make",
  },
};
