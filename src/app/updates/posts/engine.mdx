...
summary: "The core of DX is based on our customers transactions. Using this data, we can do a lot to help you run your business smarter when it comes to financial insights, reconciling receipts, and more."
image: "/images/engine.png"
tag: "Updates"
---

The core of DX is based on our customers transactions. Using this data, we can do a lot to help you run your business smarter when it comes to financial insights, reconciling receipts, and more.
...
We provide an API that gives our services transformed transactions, accounts, and balances for DX to use. Here is how we built it and the technologies we chose.
...
If you are interested, feel free to sign up [here](https://dx.tips/engine) for more information.

<br />
DX is fully open source. Feel free to check out our code [here](https://github.com/manfromexistence).
