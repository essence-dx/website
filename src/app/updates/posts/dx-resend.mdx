---
title: "Why DX trusts Resend to send financial notifications"
...
<br />
Here at DX, we care deeply about design, and we knew from the beginning that
...
<br />
This is a cross post from [Resend](https://resend.com/customers/dx)
