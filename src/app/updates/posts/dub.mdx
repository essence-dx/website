...
Earlier this week [Dub.co](http://Dub.co) shared our [customer story](https://dub.co/customers/dx) on why we choose Dub as our link-sharing infrastructure.
...
<br />
![DX - Overview](/images/overview.png)

<br />
If you look closely you can se our link looks like this: [https://github.com/manfromexistence/5eYKrmV](https://github.com/manfromexistence/5eYKrmV)
...
```typescript
const dub = new Dub({ projectSlug: "dx" });
...
<br />
You can find the source code for this in our repository [here](https://github.com/manfromexistence/tree/main/apps/dashboard/src/actions/report).
