...
summary: "DX is all about being on top of your business. Stay informed about your business insights, track when you get paid, receive updates on new transactions"
image: "/images/novu.png"
tag: "Engineering"
---

DX is all about being on top of your business. Stay informed about your business insights, track when you get paid, receive updates on new transactions, and access general information how your business actually are doing. And that includes well-timed notifications via emails and push notifications, carefully curated for your convenience.
...
We started with created our own package `@dx/notifications` where
...
And using our [New Transactions email](https://email.dx.tips/preview/transactions) as an example, which is sent from a background job using Trigger.dev when you have new transactions.

```typescript
import { Notifications, Types, Events } from "@dx/notifications";
...
<br />
![DX - In App Notifications](/images/notification-center.gif)
<br />
Thanks to the SDK `@novu/headless` we implemented the notification center for DX
...
<br />
![DX - In App Notifications](/images/notification-settings.gif)

<br />
### The future of DX x Novu
...
While this is just a draft on how we are using Novu in production you can dig deeper into the codebase in our [repository](https://github.com/manfromexistence).
