...
export const metadata = createPageMetadata({
  ...
  description:
    "Privacy Policy for DX. Learn how we collect, use, and protect your personal data.",
  path: "/policy",
  og: {
    title: "Privacy Policy",
            ...
            <div className="space-y-8">
              ...
              <div className="prose prose-sm sm:prose-base max-w-none space-y-6 font-sans text-foreground">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    DX Labs AB uses the collected data for various purposes:
                  </p>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    DX's use of information received from Google APIs will
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    DX Labs AB may process your Personal Data because:
                  </p>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                        ...
                        <li>
                          To protect and defend the rights or property of DX
                          Labs AB
                        </li>
                        <li>
