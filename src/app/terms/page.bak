...
export const metadata = createPageMetadata({
  ...
  description:
    "Terms and Conditions for using DX. Read about your rights and responsibilities when using our service.",
  path: "/terms",
            ...
            <div className="space-y-8">
              ...
              <div className="prose prose-sm sm:prose-base max-w-none space-y-6 font-sans text-foreground">
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  govern your relationship with the DX application (the
                  "Service") operated by DX Labs AB ("us", "we", or "our").
                </p>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    cancel it or DX Labs AB cancels it. You may cancel your
                    Subscription through your online account management page or
                    by contacting DX Labs AB's customer support.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    DX Labs AB may modify Subscription fees at its sole
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    and are granted at the sole discretion of DX Labs AB.
                  </p>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    DX Labs AB accepts no liability for any consequences,
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    providers. DX Labs AB does not verify the legal, tax, or
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                    ...
                    <li>
                      ...
                      own terms and policies, and DX Labs AB assumes no
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    DX Labs AB relies on third-party services (e.g., banking
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                    ...
                    <li>
                      DX Labs AB is not responsible for errors, omissions,
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    constitutes infringement, please email dmca@dx.tips with:
                  </p>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    remain the property of DX Labs AB and its licensors.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    services that are not controlled by DX Labs AB.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    DX Labs AB and its affiliates, directors, employees, and
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    DX Labs AB regarding the Service.
                  </p>
                </section>
