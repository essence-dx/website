...
export function CardsSkeletonDemo() {
  return (
    <div
      data-slot="demo"
      className="theme-neutral relative flex w-full max-w-none flex-col gap-(--gap) bg-muted p-12 pb-0! [--gap:2rem] 3xl:[--gap:2rem] min-[1900px]:[--gap:2.5rem]! lg:p-8 lg:[--gap:1.5rem] xl:p-12 dark:bg-muted/30"
    >
