            ...
            <div className="prose prose-sm sm:prose-base max-w-none space-y-8 font-sans text-foreground">
              ...
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  DX changes that by providing a cohesive, interconnected
                  ecosystem.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <ul className="text-muted-foreground leading-relaxed space-y-2 list-disc pl-6">
                  <li><strong>DX Code</strong> — GPU-accelerated code editor forked from Zed</li>
                  <li><strong>DX CLI</strong> — Central command-line interface with 150+ commands</li>
                  <li><strong>DX Web</strong> — Rust web framework with TSX authoring</li>
                  <li><strong>DX Agent</strong> — Multi-channel AI agent runtime</li>
                  <li><strong>DX Flow</strong> — Local-first workflow automation</li>
                  <li><strong>DX Forge</strong> — Content-addressed version control</li>
                  <li><strong>DX Style</strong> — Rust-native CSS engine</li>
                  <li><strong>DX Media</strong> — Universal media acquisition engine</li>
                  <li><strong>DX Metasearch</strong> — Privacy-respecting search engine</li>
                  <li><strong>DX Icon</strong> — Fastest icon search engine</li>
                  <li><strong>DX Serializer</strong> — Token-optimized serialization</li>
                  <li><strong>DCP</strong> — Development Context Protocol</li>
                  <li><strong>DX Driven</strong> — Multi-editor AI rule orchestrator</li>
                  <li><strong>DX Provider Catalog</strong> — 184 providers, 6245 models</li>
                </ul>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  integration surfaces. Build on top of DX instead of
                  fighting it.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  <strong>Open source.</strong> MIT licensed. Your tools
                  should be as open as the code you write with them.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  DX is built by DX Labs AB, a small team of engineers who
                    ...
                    GPU-accelerated editors to zero-copy serialization
                    formats to AI agent runtimes.
                  </p>
                </section>
              </div>
            </div>
