import { getModelById, getVideoModelById, getI2IModelById, getI2VModelById, getV2VModelById, getRecastModelById, getLipSyncModelById, getAudioModelById } from './models';

const MUAPI_BASE = process.env.NEXT_PUBLIC_MUAPI_BASE || 'https://api.muapi.ai';
const DIRECT_API = process.env.NEXT_PUBLIC_MUAPI_DIRECT === 'true' || typeof window === 'undefined';

const BASE_URL = DIRECT_API ? MUAPI_BASE : (
