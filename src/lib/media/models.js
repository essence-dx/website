...
export const t2iModels = [
  ...
  },
  {
    ...
    inputs: {
      prompt: {
        ...
        description:
          "Text prompt describing the image. The length of the prompt must be between 2 and 3000 characters.",
        type: "string",
        title: "Prompt",
        name: "prompt",
      },
      width: {
        ...
        type: "int",
        description:
          "Width of the output image. The value must be divisible by 64, eg: 128...512, 576, 640...2048.",
        default: 1024,
        minValue: 128,
        maxValue: 2048,
        step: 64,
      ...
      height: {
        ...
        type: "int",
        description:
          "Height of the output image. The value must be divisible by 64, eg: 128...512, 576, 640...2048.",
        default: 1024,
        minValue: 128,
        maxValue: 2048,
        step: 64,
  ...
  },
  {
    ...
    inputs: {
      ...
      model_id: {
        ...
        description:
          "The unique identifier of a LoRA model hosted on Civitai, used by the Flux Dev image generation system. This ID tells Flux Dev which specific LoRA model to apply during generation. You can find the model ID in the Civitai model URL (e.g., model_id: civitai:1642876@1864626).",
        maxItems: 4,
      },
      width: {
        title: "Width",
  ...
  },
  {
    ...
    inputs: {
      ...
      aspect_ratio: {
        enum: ["16:9", "9:16", "1:1", "4:3", "3:4", "21:9", "16:21"],
        title: "Aspect Ratio",
        name: "aspect_ratio",
        type: "string",
        description: "Aspect ratio of the output image.",
  ...
  },
  {
    ...
    inputs: {
      ...
      variety: {
        ...
        type: "int",
        description:
          "Controls the diversity of generated images. Increment by 5 each time. Higher values create more diverse results. Lower values create more consistent results.",
        default: 5,
        minValue: 0,
        maxValue: 100,
        step: 5,
      ...
      stylization: {
        ...
        type: "int",
        description:
          "Controls the artistic style intensity. Higher values create more stylized results. Lower values create more realistic results.",
        default: 1,
        minValue: 0,
        maxValue: 1000,
        step: 1,
      ...
      weirdness: {
        ...
        type: "int",
        description:
          "Controls the creativity and uniqueness. Higher values create more unusual results. Lower values create more conventional results.",
        default: 1,
        minValue: 0,
        maxValue: 3000,
        step: 1,
  ...
  },
  {
    ...
    inputs: {
      ...
      aspect_ratio: {
        enum: ["1:1", "16:9", "9:16", "3:4", "4:3", "2:3", "3:2", "21:9"],
        title: "Aspect Ratio",
        name: "aspect_ratio",
        type: "string",
        description: "Aspect ratio of the output image.",
  ...
  },
  {
    ...
    inputs: {
      ...
      aspect_ratio: {
        enum: ["1:1", "16:9", "9:16", "3:4", "4:3", "4:5", "5:4", "2:3", "3:2"],
        title: "Aspect Ratio",
        name: "aspect_ratio",
        type: "string",
        description: "Aspect ratio of the output image.",
  ...
  },
  {
    ...
    inputs: {
      ...
      aspect_ratio: {
        enum: ["16:9", "9:16", "1:1", "4:3", "3:4", "2:3", "3:2", "21:9"],
        title: "Aspect Ratio",
        name: "aspect_ratio",
        type: "string",
        description: "Aspect ratio of the output image.",
  ...
  },
  {
    ...
    inputs: {
      ...
      strength: {
        ...
        type: "int",
        description:
          "Controls the strength of the transformation. Higher values produce outputs more different from the input image.",
        default: 0.6,
        minValue: 0,
        maxValue: 1,
        step: 0.01,
...
export const t2vModels = [
  ...
  },
  {
    ...
    inputs: {
      ...
      aspect_ratio: {
        enum: ["16:9", "9:16", "1:1", "3:4", "4:3", "21:9"],
        title: "Aspect Ratio",
        name: "aspect_ratio",
        type: "string",
        description: "Aspect ratio of the output video.",
  ...
  },
  {
    ...
    inputs: {
      ...
      prompt: {
        ...
        name: "prompt",
        description:
          "Optional prompt to guide the extension. If omitted, the model continues with the original scene.",
      },
      duration: {
        enum: [5, 10, 15],
        title: "Duration",
  ...
  },
  {
    ...
    inputs: {
      ...
      duration: {
        ...
        type: "int",
        description:
          "The duration in seconds. If 8-second video is selected, 1080p resolution cannot be used.",
        default: 5,
      },
      resolution: {
        enum: ["720p", "1080p"],
        ...
        type: "string",
        description:
          "The resolution of the generated video. If 1080p is selected, 8-second video cannot be generated.",
        default: "720p",
      },
    },
  },
  ...
  },
  {
    ...
    inputs: {
      ...
      duration: {
        ...
        type: "int",
        description:
          "The duration of the generated video in seconds. 8s not supported for 1080p resolution.",
        default: 5,
        minValue: 5,
        maxValue: 8,
        step: 3,
  ...
  },
  {
    ...
    inputs: {
      ...
      duration: {
        ...
        type: "int",
        description:
          "The duration of the generated video in seconds. Currently 25 seconds supports 720p only.",
        default: 10,
      },
      resolution: {
        enum: ["720p", "1080p"],
  ...
  },
  {
    ...
    inputs: {
      ...
      mode: {
        ...
        type: "string",
        description:
          "Generation style: normal = standard output; fun = more creative/expressive; spicy = edgier content (text-to-video only).",
        default: "normal",
      },
      duration: {
        enum: [6, 10, 15],
  ...
  },
  {
    ...
    inputs: {
      prompt: {
        ...
        name: "prompt",
        description: "Text prompt describing the image.",
        examples: ["Promoting brand in professional look"],
      },
    },
  },
  {
  ...
  },
  {
    ...
    inputs: {
      ...
      weight: {
        ...
        name: "weight",
        description:
          "Weight allows you to control how much detail from your reference image appears in your new image.",
        default: 100,
        minValue: 1,
        maxValue: 1000,
        step: 1,
  ...
  },
  {
    ...
    inputs: {
      prompt: {
        ...
        description:
          "Text prompt describing the image, what you want the final edited image to look like.",
        examples: ["Replace the field with a snowy mountain landscape."],
      },
      aspect_ratio: {
        type: "string",
        title: "Aspect Ratio",
  ...
  },
  {
    ...
    inputs: {
      ...
      aspect_ratio: {
        ...
        name: "aspect_ratio",
        description: "Aspect ratio of the output image.",
        enum: ["auto", "16:9", "9:16", "1:1", "4:3", "3:4", "2:3", "3:2"],
        default: "1:1",
      },
      resolution: {
        type: "string",
  ...
  },
  {
    ...
    inputs: {
      prompt: {
        ...
        name: "prompt",
        description:
          "Text prompt describing the transformation. Up to 20,000 characters supported.",
        examples: [
...
export const i2vModels = [
  {
    ...
    inputs: {
      prompt: {
        ...
        name: "prompt",
        description:
          "The prompt to insert into the predefined prompt template for the selected effect.",
  ...
  },
  {
    ...
    inputs: {
      ...
      num_videos: {
        ...
        name: "num_videos",
        description:
          "Number of videos generated in single request. Each number will charge separately",
        enum: [1, 2, 4],
        default: 1,
      },
      variety: {
  ...
  },
  {
    ...
    inputs: {
      ...
      aspect_ratio: {
        ...
        name: "aspect_ratio",
        description:
          "Aspect ratio of the output video. 16:9 for 360p/720p, 1:1 for 1080p are supported.",
        enum: ["16:9", "1:1"],
        default: "16:9",
      },
      resolution: {
  ...
  },
  {
    ...
    inputs: {
      ...
      style: {
        ...
        enum: ["none", "anime", "3d_animation", "clay", "comic", "cyberpunk"],
        default: "none",
      },
      thinking: {
        type: "string",
...
export const v2vModels = [
  ...
  },
  {
    ...
    hasPrompt: true,
    description:
      "Kling V3.0 Standard Motion Control allows for precise control over the camera and subject movement in generated videos.",
  },
  {
...
export const lipsyncModels = [
  ...
  // ── Video + Audio → Video ──────────────────────────────────────────────────
  {
    ...
    hasPrompt: false,
    description:
      "Generate realistic lipsync animations from audio using Sync's advanced algorithms.",
  },
  {
    id: "latent-sync",
    name: "LatentSync",
    ...
    hasPrompt: false,
    description:
      "Video-to-video lipsync using LatentSync for high-quality audio-driven lip animations.",
  },
  {
    id: "creatify-lipsync",
    ...
    hasPrompt: false,
    description:
      "Realistic lipsync video optimized for speed, quality, and consistency by Creatify.",
  },
  {
    id: "veed-lipsync",
    name: "Veed Lipsync",
...
export const recastModels = [
  {
    ...
    hasPrompt: true,
    description:
      "Transfer the motion from your video onto a character image with maximum fidelity.",
  },
  {
...
export const audioModels = [
  {
    ...
    family: "suno",
    description:
      "Suno generate music that turns text prompts into full songs ΓÇö complete with vocals, lyrics, and instrumentation. You can describe a mood, genre, or even a specific lyric idea, and Suno creates a realistic, studio-quality track in seconds.",
    required: ["style"],
    inputs: {
      prompt: {
        examples: [
        ...
        description:
          "A description of the desired audio content. The prompt will be strictly used as the lyrics and sung in the generated track",
        type: "string",
        title: "Prompt",
        name: "prompt",
      },
      ...
      persona_id: {
        ...
        name: "persona_id",
        description:
          "Persona ID or custom voice ID to apply to the generated music (optional). Pair with persona_model to disambiguate.",
      },
      persona_model: {
      ...
      style_weight: {
        ...
        type: "int",
        description:
          "Strength of adherence to the specified style (optional). Range 0ΓÇô1, up to 2 decimal places.",
        minValue: 0,
        maxValue: 1,
        step: 0.05,
        default: 0.65,
      ...
      weirdness_constraint: {
        ...
        type: "int",
        description:
          "Controls experimental/creative deviation (optional). Range 0ΓÇô1, up to 2 decimal places.",
        minValue: 0,
        maxValue: 1,
        step: 0.05,
        default: 0.65,
      ...
      audio_weight: {
        ...
        type: "int",
        description:
          "Balance weight for audio features vs. other factors (optional). Range 0ΓÇô1, up to 2 decimal places.",
        minValue: 0,
        maxValue: 1,
        step: 0.05,
        default: 0.65,
  ...
  },
  {
    ...
    required: ["audio_url", "style"],
    inputs: {
      prompt: {
        examples: ["A calm and relaxing piano track with soft melodies"],
        description:
  ...
  },
  {
    ...
    required: ["prompt", "audio_url", "style"],
    inputs: {
      prompt: {
        examples: ["Extend the music with more relaxing notes"],
        description:
          "A description of the desired audio content. The prompt will be strictly used as the lyrics and sung in the generated track. Maximum 3000 characters",
        type: "string",
        title: "Prompt",
      ...
      continue_at: {
        ...
        type: "int",
        description:
          "The time point (in seconds) from which to start extending the music. Value range: greater than 0 and less than the total duration of the uploaded audio. Specifies the position in the original track where the extension should begin.",
        default: 1,
        minValue: 1,
        maxValue: 60,
        step: 1,
  ...
  },
  {
    ...
    required: ["prompt", "title", "style", "audio_url"],
    inputs: {
      prompt: {
        type: "string",
        title: "Prompt (Lyrics)",
  ...
  },
  {
    ...
    inputs: {
      ...
      instrumental: {
        ...
        name: "instrumental",
        description:
          "If true: Only style is required else style, and prompt are required (with prompt used as the exact lyrics)",
        default: true,
      },
      model: {
        enum: ["V4", "V4_5", "V4_5PLUS", "V5"],
  ...
  },
  {
    ...
    family: "minimax-2.3",
    description:
      "Minimax Voice Clone creates a high-fidelity digital clone of a speakerΓÇÖs voice from a short reference audio sample. It reproduces the speakerΓÇÖs tone, emotion, accent, rhythm, and speaking style, then generates new speech from any text input.",
    required: ["audio_url", "custom_voice_id"],
    inputs: {
      audio_url: {
        examples: [
          "https://d3adwkbyhxyrtq.cloudfront.net/webassets/videomodels/minimax-voice-clone-in.wav",
  ...
  },
  {
    ...
    family: "minimax-2.6",
    description:
      "Speech-2.6-hd is MinimaxΓÇÖs high-definition text-to-speech model that turns written text into natural, human-like audio. It produces studio-quality speech with clear pronunciation, smooth pacing, realistic emotion, and no background noise.",
  ...
  },
  {
    ...
    family: "minimax-2.6",
    description:
      "Speech-2.6-turbo is MinimaxΓÇÖs fast, lightweight text-to-speech model designed for quick audio generation while maintaining good natural voice quality. It produces clear speech with smooth pacing and minimal delay.",
    required: ["prompt", "voice_id"],
    inputs: {
      prompt: {
        examples: [
