...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex size-10 items-center justify-center border border-transparent border-b-input bg-transparent text-sm transition-[color,border-color] outline-none first:rounded-none last:rounded-none aria-invalid:border-b-destructive data-&lsqb;active=true&rsqb;:z-10 data-&lsqb;active=true&rsqb;:border-b-ring dark:aria-invalid:border-b-destructive/50",
        className
      )}
      {...props}
    >
