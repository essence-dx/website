...
import { toggleVariants } from "@/styles/v4/radix-maia/ui/toggle"
...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive.Root
      ...
      className={cn(
        "group/toggle-group flex w-fit flex-row items-center gap-[calc(var(--gap)*0.25rem)] data-[spacing=0]:data-[variant=outline]:rounded-4xl data-vertical:flex-col data-vertical:items-stretch",
        className
      )}
      {...props}
    >
