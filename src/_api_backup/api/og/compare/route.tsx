...
export async function GET(request: NextRequest) {
  ...
  const hedvigSansFont = fetch(
    "https://raw.githubusercontent.com/google/fonts/main/ofl/hedvigletterssans/HedvigLettersSans-Regular.ttf",
  ...
  const subtitle = competitorName
    ? `See why founders are switching from ${competitorName} to DX`
