...
import { CursorMcpLogo } from "@dx/app-store/logos";
...
const cursorDeepLink = `cursor://anysphere.cursor-deeplink/mcp/install?name=dx&config=${encodeURIComponent(btoa(JSON.stringify(cursorConfig)))}`;
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="space-y-4 mb-12">
              ...
              <p className="font-sans text-xs text-muted-foreground">
                ...
                OAuth. You'll be prompted to sign in when you first use a DX
                tool.
              </p>
            </div>
            ...
            <div className="mt-12 space-y-4">
              ...
              <ol className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="font-sans text-sm text-muted-foreground pt-0.5">
                    @-mention DX in chat to access your development data
                  </span>
                </li>
              </ol>
            </div>
