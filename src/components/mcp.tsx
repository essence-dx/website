...
const clients = [
  {
    id: "cursor",
    name: "Cursor",
    description: "Run DX tools without leaving your editor",
    href: "/mcp/cursor",
  },
  {
    id: "claude",
    name: "Claude",
    description: "Manage builds, agents, and deploys via chat",
    href: "/mcp/claude",
  },
  {
    id: "perplexity",
    name: "Perplexity",
    description: "Search your codebase and docs with AI",
    href: "/mcp/perplexity",
  },
  {
    id: "raycast",
    name: "Raycast",
    description: "Quick commands, one shortcut away",
    href: "/mcp/raycast",
  },
  {
    id: "chatgpt",
    name: "ChatGPT",
    description: "Build custom DX integrations",
    href: "/mcp/chatgpt",
  },
  {
    id: "gemini",
    name: "Gemini",
    description: "DX tools from your terminal",
    href: "/mcp/gemini",
  },
  {
    id: "windsurf",
    name: "Windsurf",
    description: "DX tools in your AI IDE",
    href: "/mcp/windsurf",
  },
  {
    id: "cline",
    name: "Cline",
    description: "DX tools in VS Code",
    href: "/mcp/cline",
  },
  {
    id: "zed",
    name: "Zed",
    description: "DX tools in the fastest editor",
    href: "/mcp/zed",
  },
  {
    id: "opencode",
    name: "OpenCode",
    description: "Manage DX from your terminal agent",
    href: "/mcp/opencode",
  },
  {
    id: "zapier",
    name: "Zapier",
    description: "Automate DX workflows with 7,000+ apps",
    href: "/mcp/zapier",
  },
  {
    id: "copilot",
    name: "Microsoft Copilot",
    description: "Query DX tools from Microsoft 365",
    href: "/mcp/copilot",
  },
  {
    id: "n8n",
    name: "n8n",
    description: "Automate DX workflows with AI agents",
    href: "/mcp/n8n",
  },
  {
    id: "make",
    name: "Make",
    description: "Visual DX automations with 1,500+ apps",
    href: "/mcp/make",
  },
  {
    id: "manus",
...
const questions = [
  "Build and deploy the web project",
  "Which agents are running?",
  "Search icons for a navigation bar",
  "Compile my CSS with DX Style",
  "Run validation checks on the project",
  "Translate these strings to Spanish",
  "What's in my media library?",
  "Show me the provider catalog",
  "Start a forge build for production",
  "Search for images of the sunset",
  "Create an agent that monitors errors",
  "Generate a serializer schema",
...
const capabilities = [
  "80+ tools — code, build, web, agents, media, search, style, and more",
  "Full tool lifecycle — init, configure, run, monitor from any AI client",
  "Cross-platform — works with Cursor, Claude, Perplexity, Raycast, Zed, and more",
  "Granular permissions — read-only or full access, you choose",
  "One protocol — DCP and MCP, every tool, any client",
];
