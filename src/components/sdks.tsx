...
export function SDKs() {
  ...
  const sdkRepos: Record<SDKTab, string> = {
    typescript: "https://github.com/dx/dx-ts",
    go: "https://github.com/dx/dx-go",
    php: "https://github.com/dx/dx-php",
  };
          ...
          <div className="flex flex-col justify-start items-center z-20 px-4 sm:px-6">
            ...
            <div className="space-y-4 text-center max-w-xl w-full">
              ...
              <p className="text-muted-foreground text-base leading-normal font-sans text-center mx-auto">
                Use DX's SDKs to integrate developer tools, AI agents, and
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 w-full max-w-md mx-auto justify-center sm:justify-center mt-8">
              ...
              >
                <Link href="https://api.dx.tips">API documentation</Link>
              </Button>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <InstallTabs packageName="@dx/sdk" />
                  </div>
...
const dx = new DX({
  security: {
    oauth2: process.env["DX_OAUTH2"] ?? "",
  },
});

async function run() {
  const result = await dx.oAuth.getOAuthAuthorization({
    responseType: "code",
    clientId: "mid_client_abcdef123456789",
    redirectUri: "https://myapp.com/callback",
    scope: "projects.read builds.read",
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <CodeBlock
                    code="go get github.com/dx/dx-go"
                    language="bash"
                  />
                </div>
...
import (
	"context"
	dxgo "github.com/dx/dx-go"
	"github.com/dx/dx-go/models/operations"
	"log"
)
          ...
          {activeTab === "php" && (
            <div className="max-w-4xl mx-auto space-y-8">
              <div className="text-center space-y-4">
                ...
                <p className="font-sans text-base text-muted-foreground leading-normal max-w-2xl mx-auto">
                  A PHP SDK for integrating DX's APIs into your PHP
                  applications.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <CodeBlock
                    code="composer require dx/dx-php"
                    language="bash"
                  />
                </div>
...
use DXDX;
use DXDXModelsOperations;

$sdk = DXDX::builder()
    ->setSecurity('DX_API_KEY')
    ->build();
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-sans text-sm text-foreground">
                    ...
                    <span className="hidden sm:inline">
                      Monitor builds and deployments programmatically and build
                      custom dashboards
                    </span>
                  </span>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-sans text-sm text-foreground">
                    ...
                    <span className="hidden sm:inline">
                      Manage AI agents and workflows tailored to your needs
                    </span>
                  </span>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-sans text-sm text-foreground">
                    Integrate code generation and review into your existing
                    workflows
                  </span>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-sans text-sm text-foreground">
                    ...
                    <span className="hidden sm:inline">
                      Automate CI/CD and deployment pipelines for your projects
                    </span>
                  </span>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                ...
                <p className="font-sans text-sm text-muted-foreground">
                  Get started with DX SDKs in minutes.
                </p>
              </Link>
              <Link
                href={sdkRepos[activeTab]}
