"use client";
import { N8nMcpLogo } from "@dx/app-store/logos";
...
const automationExamples = [
  ...
  "Send Slack alerts when builds fail repeatedly",
  "Create weekly build reports and email them",
  "Update spreadsheets with real-time build data",
];
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="space-y-4 mb-8">
              ...
              <p className="font-sans text-base text-muted-foreground leading-relaxed">
                {" "}
                Connect DX to n8n workflows via MCP. Use the MCP Client node to
                access your financial data in automated workflows and AI agents.{" "}
              </p>{" "}
            </div>{" "}
            {/* Use Cases */}{" "}
