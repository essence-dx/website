...
import { type Color, type ColorPalette } from "@/lib/v4/colors"
...
import { useConfig } from "@/hooks/v4/use-config"
import { useMutationObserver } from "@/hooks/v4/use-mutation-observer"
