        ...
        <div className="flex items-center">
          {colors.map((colorPalette, index) => (
            <Link
              ...
              className={cn(
                "flex h-7 items-center justify-center px-4 text-center text-base font-medium text-muted-foreground capitalize transition-colors hover:text-primary data-&lsqb;active=true&rsqb;:text-primary"
              )}
            >
              {colorPalette.name}
            </Link>
