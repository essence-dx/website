        ...
        <div className={cn("flex items-center", className)} {...props}>
          {links.map((link) => (
            <Link
              ...
              className={cn(
                "flex h-7 shrink-0 items-center justify-center px-4 text-center text-base font-medium text-muted-foreground transition-colors hover:text-primary data-&lsqb;active=true&rsqb;:text-primary"
              )}
            >
              {link.name}
            </Link>
