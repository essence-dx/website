...
import { trackEvent } from "@/lib/v4/events"
import {
  type createFileTreeForRegistryItemFiles,
  type FileTree,
} from "@/lib/v4/registry"
import { cn } from "@/lib/v4/utils"
import { useCopyToClipboard } from "@/hooks/v4/use-copy-to-clipboard"
import { getIconForLanguageExtension } from "@/components/v4/icons"
import { OpenInV0Button } from "@/components/v4/open-in-v0-button"
    ...
    return (
      <SidebarMenuItem>
        <SidebarMenuButton
          ...
          className="rounded-none pl-(--index) whitespace-nowrap hover:bg-muted-foreground/15 focus:bg-muted-foreground/15 focus-visible:bg-muted-foreground/15 active:bg-muted-foreground/15 data-&lsqb;active=true&rsqb;:bg-muted-foreground/15"
          data-index={index}
          style={
            {
