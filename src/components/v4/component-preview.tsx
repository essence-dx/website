...
import { getRegistryComponent } from "@/lib/v4/registry"
import { ComponentPreviewTabs } from "@/components/v4/component-preview-tabs"
...
function CDNRendering({
  ...
  const content = (
    <ComponentPreviewTabs
      ...
      align={align}
      hideCode={hideCode}
      component={<LivePreview name={name} styleName={styleName} />}
      source={
        <ComponentSource
          name={name}
          collapsible={false}
