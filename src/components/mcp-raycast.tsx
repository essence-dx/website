          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="space-y-4 mb-12">
              <a
                ...
                className="inline-flex items-center justify-center text-sm font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 w-full sm:w-auto h-11 px-6 text-sm font-sans"
              >
                Add to Raycast
              </a>
