...
const headerTestimonials: Testimonial[] = [
  ...defaultTestimonials,
  {
    ...
    content:
      "All in one platform for developer teams looking to create clear insights on builds, agents, and projects.",
    fullContent:
      "Having a clear overview of builds, agents, and projects in one place made managing development work much easier.\n\nFavorite features\nAgents, because it's a huge time saver.\nBuild monitoring gives a very clear picture.\nAutomated deploys being taken from my CI and being able to track everything is a huge one.",
  },
  {
    name: "Nick Speer",
    title: "",
    ...
    content:
      "DX is build tooling without the fluff. It's a modern CLI with Agent integration and real-time feedback.",
    fullContent:
      "Company\nSpeer Technologies is an AI consulting firm in the US. We accelerate our clients' AI initiatives from problem discovery to production across industries including Finance, Healthcare, and Defense.\n\nChallenge\nI was spending too much time on weekends juggling multiple build tools, CI configs, and package managers. It felt like another job, and the other solutions didn't work the way I wanted.\n\nImpact\nAfter switching to DX, it felt like I was in control of my toolchain. I could see every build and deploy as it came in and manage it without feeling overwhelmed.\n\nFavorite features\nDX Build auto-detects project configs far better than other programs, which saves time from manually configuring pipelines. From there, I can monitor deploys and get insights into exact build times.",
  },
  {
    name: "Ivo Dukov",
    title: "",
    ...
    country: "Bulgaria",
    content:
      "Everything lives in one place now — code, builds, agents, and deploys.",
    fullContent:
      "Company\nSmarch is a software development agency specializing in e-commerce, web applications, and custom backend systems.\n\nChallenge\nBefore DX, I was manually wiring up CI pipelines, piecing together monitoring dashboards, and collecting logs every time something broke. It was scattered and tedious.\n\nImpact\nEverything lives in one place now. I set up build templates once, have all projects organized, get real analytics on pipeline performance, and keep artifacts in a proper vault. What used to take hours of ops work is now streamlined and mostly automatic.\n\nFavorite features\nDX Flow templates. They eliminate repetitive work when setting up new projects.",
  },
  {
    name: "Isabel Sá",
    title: "",
    ...
    country: "Portugal",
    content:
      "I find myself having a better sense of pipeline health than before. The auto-orchestration of builds and deploys is a game changer.",
    fullContent:
      "Company\nCharacter is a software design studio.\n\nChallenge\nGetting the big picture across multiple repos and CI runners. We have both frontend and backend builds, and orchestrating these was always difficult. There was no easy way to see everything in one place.\n\nImpact\nA much better sense of pipeline health than before. Both bigger picture things like build times and smaller things like keeping an eye on deploy failures and removing unused workflows. The engineering team just checks DX to grab what they need.\n\nFavorite features\nDX Agent and Build. The Build tab was already a major upgrade from the previous workflow in multiple CI dashboards, but the auto-orchestration of code review and deploys is a game changer. Drastically reduced time spent on it. We're also in the process of migrating all projects to DX to get the full network effect.",
  },
  {
    name: "Ciarán Harris",
    title: "",
    ...
    content:
      "Toolchain management stopped being a source of friction. DX actually works the way you'd expect modern developer tools to work.",
    fullContent:
      "Company\nCogniStream is an AI-moderated qualitative research platform. We have natural voice conversations with customers, analyse not just what they say but how they feel when they say it, and help businesses make confident decisions faster. I'm Ciarán Harris, CEO and Co-Founder, a two-time founder with over 25 years of research experience for global giants.\n\nChallenge\nI tried using scattered CLI tools. They couldn't integrate with each other reliably, the interfaces felt like they hadn't been updated in a decade, and just getting up and running was painful. It never worked out of the box. As a founder, you need development tooling to just work so you can focus on building the business. It wasn't working.\n\nImpact\nToolchain management stopped being a source of friction. DX actually works the way you'd expect modern developer tools to work. I check in every few days to keep on top of builds, and every few weeks I'll do a more involved session to review deploys and agent tasks. It removed the single biggest pain point from my week-to-week development workflow, and everything else it does is a genuinely useful bonus on top of that.\n\nFavorite features\nDX Agent and Build monitoring, without question. That's the feature that removes the most friction from running development day to day. Before, builds were scattered and monitoring them was tedious. Now it's handled. That one feature alone justified the switch. The DX CLI is a nice bonus too, being able to run commands across all projects from one terminal is genuinely useful.",
  },
];
                          ...
                          >
                            ...
                            <div className="bg-background border-t border-border p-2.5 flex items-center justify-between gap-4">
                              <div className="flex-1">
                                ...
                                <span className="font-sans text-xs text-muted-foreground group-hover:text-foreground transition-colors duration-200">
                                  All DX tools work together seamlessly
                                </span>
                              </div>
                            ...
                            <div>
                              {[
                                ...
                                },
                                {
                                  ...
                                  desc: "Connect AI tools to your DX data.",
                                  external: false,
                                },
                              ].map((item, index) => (
                                <div
                            ...
                            <div>
                              {[
                                ...
                                },
                                {
                                  href: "/chat",
                                  title: "Chat",
                                  desc: "Manage your DX tools from chat.",
                                  external: false,
                                },
                                {
                                  href: "/computer",
                                  title: "Computer",
                                  desc: "Autonomous agents for your toolchain.",
                                  external: false,
                                },
                              ].map((item, index) => (
                                <div
                        ...
                        <div className="lg:col-span-2 flex items-start justify-end gap-4 flex-nowrap">
                          ...
                          >
                            ...
                            <div className="bg-background border-t border-border p-2.5">
                              ...
                              <span className="font-sans text-xs text-muted-foreground group-hover:text-foreground transition-colors duration-200">
                                Your toolchain, always one click away.
                              </span>
                            </div>
                          </Link>
                        </div>
