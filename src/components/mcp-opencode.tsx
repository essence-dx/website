"use client";
import { OpenCodeMcpLogo } from "@dx/app-store/logos";
            ...
            <div className="space-y-3 mb-8 p-4 bg-secondary/50 border border-border">
              ...
              <ul className="space-y-2">
                ...
                <li className="font-sans text-sm text-muted-foreground flex items-start gap-2">
                  {" "}
                  <span className="text-foreground">•</span> "Start timer for
                  [customer name]"{" "}
                </li>{" "}
                <li className="font-sans text-sm text-muted-foreground flex items-start gap-2">
                  {" "}
                  <span className="text-foreground">•</span> "Stop timer and log
                  2 hours of backend work"{" "}
                </li>{" "}
                <li className="font-sans text-sm text-muted-foreground flex items-start gap-2">
                  {" "}
                  <span className="text-foreground">•</span> "How many hours did
                  I track this week?"{" "}
                </li>{" "}
                <li className="font-sans text-sm text-muted-foreground flex items-start gap-2">
                  {" "}
                  <span className="text-foreground">•</span> "Show unbilled time
                  for Acme Corp"{" "}
                </li>{" "}
              </ul>{" "}
            </div>{" "}
              ...
              <div className="flex border-b border-border">
                ...
                {(["curl", "npm", "bun", "brew"] as Tab[]).map((tab) => (
                  <button
                    ...
                    className={`px-4 py-2 text-sm font-sans transition-colors relative ${activeTab === tab ? "text-foreground" : "text-muted-foreground hover:text-foreground"}`}
                  >
                    {" "}
                    {tab}{" "}
                    {activeTab === tab && (
