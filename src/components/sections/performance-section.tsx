...
const charts: MetricChart[] = [
  {
    ...
    data: [{ name: "Languages", tslint: 30, eslint: 40, prettier: 50, biome: 60, sonarqube: 75, dx: 100 }],
  ...
  },
  {
    ...
    data: [{ name: "Overhead", graphql: 90, grpc: 85, trpc: 80, jsonrpc: 70, rest: 95, dx: 15 }],
  ...
  },
  {
    ...
    data: [{ name: "Platforms", midjourney: 20, a1111: 30, fooocus: 40, invokeai: 50, comfyui: 65, dx: 95 }],
  ...
  },
  {
    ...
    data: [{ name: "Load Time", copilot: 85, aider: 80, claude: 75, cursor: 70, windsurf: 65, dx: 10 }],
  ...
  },
  {
    ...
    data: [{ name: "Runtimes", gpt4all: 35, ollama: 45, lmstudio: 55, localai: 50, llamacpp: 60, dx: 90 }],
  ...
  },
  {
    ...
    data: [{ name: "Backends", goproxy: 40, npm: 50, pypi: 45, dockerhub: 60, cratesio: 70, dx: 100 }],
  ...
  },
  {
    ...
    data: [{ name: "Formats", flutterl10n: 35, gettext: 40, formatjs: 50, icu4x: 60, i18next: 65, dx: 95 }],
  ...
  },
  {
    ...
    data: [{ name: "Icons", lucide: 25, phosphor: 35, nucleo: 50, iconify: 70, icones: 65, dx: 100 }],
  ...
  },
  {
    ...
    data: [{ name: "Capabilities", quickjs: 30, nodejs: 40, deno: 55, bun: 75, swc: 65, dx: 95 }],
    ...
    footer: "All of Bun + DX receipts, CSS parsing, SQL, and ecosystem contracts."
  },
  {
    type: "radar",
    title: "10. DX Media: Built-in Tools",
    subtitle: "Higher is better (Media tools)",
    data: [{ name: "Tools", gstreamer: 25, exiftool: 35, imagemagick: 50, ffmpeg: 75, handbrake: 65, dx: 100 }],
  ...
  },
  {
    ...
    data: [{ name: "Engines", brave: 30, google: 40, bing: 45, duckduckgo: 55, searxng: 75, dx: 100 }],
  ...
  },
  {
    ...
    data: [{ name: "Size", electron: 95, dotnet: 80, reactnative: 70, flutter: 60, tauri: 25, dx: 15 }],
  ...
  },
  {
    ...
    data: [{ name: "Implementations", anthropic: 35, openai: 40, ollama: 45, openrouter: 65, litellm: 75, dx: 100 }],
  ...
  },
  {
    ...
    data: [{ name: "Speedup", jython: 20, ironpython: 25, cpython: 35, pypy: 60, micropython: 45, dx: 95 }],
  ...
  },
  {
    ...
    subtitle: "Lower is better (Milliseconds)",
    data: [{ name: "Parse Time", xml: 120, json: 100, yaml: 90, protobuf: 75, messagepack: 65, dx: 10 }],
  ...
  },
  {
    ...
    data: [{ name: "Lookup Time", cssmodules: 110, styledcomponents: 95, sass: 80, tailwind: 65, unocss: 50, dx: 15 }],
    keys: ["cssmodules", "styledcomponents", "sass", "tailwind", "unocss", "dx"],
    config: {
      cssmodules: { label: "CSS Modules", color: "hsl(var(--chart-1))" },
      styledcomponents: { label: "styled-components", color: "hsl(var(--chart-2))" },
  ...
  },
  {
    ...
    subtitle: "Higher is better (Multiplier)",
    data: [{ name: "Speedup", llamafactory: 35, hftrl: 40, axolotl: 55, qlora: 70, unsloth: 80, dx: 95 }],
  ...
  },
  {
    ...
    data: [{ name: "Throughput", remix: 45, nextjs: 50, sveltekit: 60, solidstart: 65, astro: 75, dx: 100 }],
  ...
  },
  {
    ...
    data: [{ name: "Channels", windsurf: 40, aider: 45, copilot: 50, codex: 60, claudecode: 65, dx: 100 }],
  ...
  },
  {
    ...
    subtitle: "Lower is better (Milliseconds)",
    data: [{ name: "Build Time", turbopack: 110, webpack: 95, parcel: 80, esbuild: 60, rolldown: 40, dx: 20 }],
...
const renderChartContent = (chart: MetricChart) => {
  ...
  if (chart.type === "bar") {
    return (
      <ChartContainer config={activeConfig} className="h-full w-full min-h-[250px]">
        <BarChart data={sequenceData} margin={{ top: 20, right: 10, left: 10, bottom: 20 }}>
          ...
          />
          <ChartTooltip cursor={{ fill: 'var(--muted)' }} content={<ChartTooltipContent nameKey="competitor" />} />
          <Bar dataKey="value" radius={6} isAnimationActive={true} animationDuration={1500} animationBegin={200}>
  ...
  if (chart.type === "area") {
    return (
      <ChartContainer config={activeConfig} className="h-full w-full min-h-[250px]">
        <AreaChart data={sequenceData} margin={{ top: 20, right: 10, left: 10, bottom: 20 }}>
          <defs>
            <linearGradient id={`color-${chart.title.replace(/\s+/g, '')}`} x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%" stopColor="hsl(var(--chart-6))" stopOpacity={0.6}/>
          ...
          <XAxis 
            ...
            tickFormatter={(v) => v.length > 10 ? v.substring(0, 10) + '...' : v} 
          />
          <ChartTooltip content={<ChartTooltipContent nameKey="competitor" />} />
          <Area 
            type="monotone" 
            dataKey="value" 
  ...
  if (chart.type === "line") {
    return (
      <ChartContainer config={activeConfig} className="h-full w-full min-h-[250px]">
        <LineChart data={sequenceData} margin={{ top: 20, right: 20, left: 20, bottom: 20 }}>
          <CartesianGrid vertical={false} strokeDasharray="3 3" stroke="hsl(var(--border))" opacity={0.5} />
          <XAxis 
            dataKey="competitor" 
            tickLine={false} 
          ...
          <Line 
            ...
            dot={(props: any) => {
              ...
              return <circle key={payload.competitor} cx={cx} cy={cy} r={6} fill={payload.fill} stroke="hsl(var(--border))" strokeWidth={2} />;
            }} 
  ...
  if (chart.type === "radial") {
    return (
      <ChartContainer config={activeConfig} className="h-full w-full min-h-[250px]">
        ...
        >
          <ChartTooltip cursor={{ fill: 'transparent' }} content={<ChartTooltipContent nameKey="competitor" />} />
          <RadialBar 
            dataKey="value" 
  ...
  if (chart.type === "radar") {
    return (
      <ChartContainer config={activeConfig} className="h-full w-full min-h-[250px]">
        <RadarChart data={sequenceData} margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
          <ChartTooltip content={<ChartTooltipContent nameKey="competitor" />} />
          <PolarGrid stroke="hsl(var(--border))" />
          <PolarAngleAxis dataKey="competitor" tick={{ fill: "hsl(var(--muted-foreground))", fontSize: 11 }} />
          <Radar 
            dataKey="value" 
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="font-sans text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
            DX tools are built from scratch in Rust, rigorously benchmarked against the market leaders.
            Every benchmark measured, not estimated. Here is the exact breakdown.
          </p>
        </motion.div>
