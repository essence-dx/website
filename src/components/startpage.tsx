...
const TransactionFlowAnimation = dynamic(() =>
  import("@dx/ui/animations/transaction-flow").then(
...
const features = [
  {
    title: "Your entire toolchain, unified",
    subtitle:
      "DX brings code, web, agents, media, search, and more into one connected ecosystem.",
    mobileSubtitle: "All your DX tools in one connected ecosystem.",
    illustration: "animation",
  },
  {
    title: "Build and deploy with ease",
    subtitle:
      "DX build, forge, and flow work together so you can ship faster without the overhead.",
    mobileSubtitle: "Ship faster with connected DX tools.",
    illustration: "animation",
  },
  {
    title: "Automated development workflows",
    subtitle:
      "From code to production, DX automates the repetitive work so you can focus on building.",
    mobileSubtitle: "Automate repetitive work across your toolchain.",
    illustration: "animation",
  },
];
            ...
            <div className="flex flex-col items-center w-full text-center space-y-6 lg:space-y-8">
              <div className="space-y-5 lg:space-y-6 max-w-4xl 3xl:max-w-5xl mx-auto px-2 lg:px-0">
                <div className="relative w-full h-[400px] mb-8 overflow-hidden rounded-xl">
                  <Heatmap className="w-full h-full" {...heatmapDefaults} colorBack="transparent" scale={1.5} colors={heatmapDefaults.colors} image="/images/logos/diamond.svg" suspendWhenProcessingImage={false} />
                </div>
