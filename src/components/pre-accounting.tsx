...
import { BulkReconciliationAnimation } from "@dx/ui/animations/bulk-reconciliation";
import { DashboardAnimation } from "@dx/ui/animations/dashboard";
import { InboxMatchAnimation } from "@dx/ui/animations/inbox-match";
import { TransactionFlowAnimation } from "@dx/ui/animations/transaction-flow";
...
const howItWorksSteps = [
  {
    title: "Builds triggered automatically",
    subtitle:
      "Commits and PRs are picked up from connected git providers automatically.",
  },
  {
    title: "Dependencies validated",
    subtitle:
      "Logs are pulled from CI/CD, git hooks, and monitoring and matched to the right projects.",
  },
  {
    title: "Tests and linting applied",
    subtitle:
      "Builds are validated continuously, with test results and lint stored where it belongs.",
  },
  {
          ...
          <div className="flex flex-col justify-start items-center space-y-8 z-20 px-4 sm:px-6">
            ...
            <div className="space-y-4 text-center max-w-xl w-full pt-4">
              <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl leading-tight text-foreground">
                Pre-deployment checks, handled.
              </h1>
              <p className="text-muted-foreground text-base leading-normal font-sans text-center mx-auto">
                DX collects, validates, and prepares your code so your deploys
                are always ready before they reach production.
              </p>
            </div>
