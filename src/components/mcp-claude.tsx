...
import { ClaudeMcpLogo } from "@dx/app-store/logos";
...
export function MCPClaude() {
  ...
  const cliCommand = useMemo(() => {
    ...
    return `claude mcp add --transport http dx https://api.dx.tips/mcp --header "Authorization: Bearer ${key}"`;
  }, [apiKey]);
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="space-y-4 mb-8">
              ...
              <p className="font-sans text-base text-muted-foreground leading-relaxed">
                Connect DX to Claude and get AI-powered development insights
                grounded in your real DX data. Authentication is handled
            ...
            {activeTab === "connect" && (
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  <CopyableUrl url="https://api.dx.tips/mcp" />
                </div>
            ...
            {activeTab === "code" && (
              <div className="space-y-6">
                <p className="font-sans text-sm text-muted-foreground">
                  Add the DX MCP server to Claude Code. OAuth authentication
                  will be handled automatically in your browser:
                </p>
                <CodeBlock code="claude mcp add --transport http dx https://api.dx.tips/mcp" />
                ...
                <div className="mt-12 space-y-4">
                  ...
                  <ol className="space-y-3">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span className="font-sans text-sm text-muted-foreground pt-0.5">
                        Use @dx in Claude Code to access your data
                      </span>
                    </li>
                  </ol>
                </div>
