...
import { GeminiMcpLogo } from "@dx/app-store/logos";
...
export function MCPGemini() {
  ...
  const cliCommand = useMemo(() => {
    ...
    return `gemini mcp add --transport http --header "Authorization: Bearer ${key}" dx https://api.dx.tips/mcp`;
  }, [apiKey]);
              ...
              <div className="space-y-6">
                <div className="space-y-3">
                  <p className="font-sans text-sm text-muted-foreground">
                    Run this command to add the DX MCP server. OAuth will be
                    handled automatically in your browser:
                  </p>
                  <CodeBlock code="gemini mcp add --transport http dx https://api.dx.tips/mcp" />
                </div>
            ...
            {activeTab === "advanced" && (
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="font-sans text-xs text-muted-foreground">
                    Place this file in your project directory or{" "}
                    <span className="font-mono">~/.gemini/settings.json</span>{" "}
                    for global access.
                  </p>
                </div>
              </div>
