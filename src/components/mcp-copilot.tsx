...
export function MCPCopilot() {
  ...
  const connectionConfig = useMemo(() => {
    ...
    return `Server URL: https://api.dx.tips/mcp
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="space-y-4 mb-8">
              <h2 className="font-serif text-xl sm:text-2xl text-foreground">
                Query your DX data from Microsoft 365
              </h2>
              <p className="font-sans text-base text-muted-foreground leading-relaxed">
                Connect DX to Microsoft Copilot Studio. Ask about builds,
                agents, projects, and reports from any Copilot-enabled app.
              </p>
            </div>
