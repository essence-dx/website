...
import { AIAssistantAnimation } from "@dx/ui/animations/ai-assistant";
...
export function Insights() {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="flex flex-col justify-start items-center space-y-6 z-20 px-3 sm:px-4">
            <div className="space-y-4 text-center max-w-xl px-2 w-full">
              ...
              <p className="text-muted-foreground text-base leading-normal font-sans text-center mx-auto lg:hidden">
                Understand how your projects are evolving over time.
              </p>
              <p className="text-muted-foreground text-base leading-normal font-sans text-center mx-auto hidden lg:block">
                Understand how your projects are evolving over time with live
              ...
              <div className="flex items-center">
                <div className="space-y-3 lg:space-y-5 text-center lg:text-left w-full">
                  ...
                  <p className="font-sans text-base text-muted-foreground leading-normal max-w-lg mx-auto lg:mx-0">
                    Key dashboard widgets give you a live view of builds,
                    deploys, agent runs, and performance, all customizable to
              ...
              <div className="flex items-center lg:order-2">
                <div className="space-y-3 lg:space-y-5 text-center lg:text-left w-full">
                  ...
                  <p className="font-sans text-base text-muted-foreground leading-normal max-w-lg mx-auto lg:mx-0">
                    ...
                    showing how builds, deploys, agent runs, and key metrics
                    changed since the last period.
                  </p>
                  <div className="flex flex-wrap justify-center lg:justify-start gap-2 pt-2">
                    <div className="flex items-center gap-2 px-3 py-1.5 rounded-full border border-border bg-background">
                      <span className="font-sans text-sm text-foreground">
      ...
      <AudioSummarySection audioUrl="https://cdn.dx.tips/weekly-speech.mp3" />
