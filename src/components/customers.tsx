...
import { CompanyEnrichmentAnimation } from "@dx/ui/animations/company-enrichment";
import { CustomerStatementAnimation } from "@dx/ui/animations/customer-statement";
              ...
              <div className="flex items-center">
                <div className="space-y-3 lg:space-y-5 text-center lg:text-left w-full">
                  <h2 className="font-sans text-2xl sm:text-2xl text-foreground">
                    Project builds and activity
                  </h2>
                  <p className="font-sans text-base text-muted-foreground leading-normal max-w-lg mx-auto lg:mx-0">
                    See build status, test results, deploys, and activity per
                    project in one place, with automatically enriched project
                    details and a shareable dashboard when needed.
                  </p>
