...
import { Field, FieldGroup, FieldLabel } from "@/registry/radix-rhea/ui/field"
import { Input } from "@/registry/radix-rhea/ui/input"
import {
  ToggleGroup,
  ToggleGroupItem,
} from "@/registry/radix-rhea/ui/toggle-group"
import { IconPlaceholder } from "@/app/v4/(create)/components/icon-placeholder"

const spacingOptions = [
  {
    className: "[--card-spacing:1rem]",
    label: "16px",
    value: "4",
  },
  {
    className: "[--card-spacing:1.25rem]",
    label: "20px",
    value: "5",
  },
  {
    className: "[--card-spacing:1.5rem]",
    label: "24px",
    value: "6",
  },
  {
    className: "[--card-spacing:2rem]",
    label: "32px",
    value: "8",
  },
]
